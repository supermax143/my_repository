package vk.api {
  ...
  public class DataProvider {    
    ...
    public function request(method: String, options: Object = null):void {
      ...
      options.onComplete = options.onComplete ? options.onComplete : null;
      options.onError = options.onError ? options.onError : null;
    ...
    private function _sendRequest(method:String, options:Object):void {
      ...
      loader.addEventListener(Event.COMPLETE, function(e:Event):void{
        ...
        if (data.name()=='error') {
          options.onError(new VKResponce(data));
        } else if (options.onComplete && data.response) {
          options.onComplete(new VKResponce(data));
        }
      });
      try {
        loader.load(request);
